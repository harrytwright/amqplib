...
declare class Connection extends EventEmitter {
	...
	createChannel(fn: Callback<Channel>): void

	createConfirmChannel(fn: Callback<Channel>): void

	close(fn?: ErrorCallback): null
}
...
declare class Channel extends EventEmitter {
	 ...
	 * */
	assertQueue(queue: string): this
	assertQueue(queue: string, options: Partial<IAssertQueueOptions>): this
	assertQueue(queue: string, options: Partial<IAssertQueueOptions>, callback: Callback<IAssertQueueFields>): this
	 ...
	 * */
	checkQueue(queue: string): this
	checkQueue(queue: string, callback: Callback<ICheckQueueFields>): this
	 ...
	 * */
	deleteQueue(queue: string): this
	deleteQueue(queue: string, options: Partial<IDeleteQueueOptions>): this
	deleteQueue(queue: string, options: Partial<IDeleteQueueOptions>, callback: Callback<IDeleteQueueFields>): this
	 ...
	 * */
	purgeQueue(queue: string): this
	purgeQueue(queue: string, callback: Callback<IPurgeQueueFields>): this
	 ...
	 * */
	bindQueue(queue: string, source: string, pattern: string): this
	bindQueue(queue: string, source: string, pattern: string, args: object): this
	bindQueue(queue: string, source: string, pattern: string, args: object, callback: Callback<IBindQueueFields>): this
	 ...
	 * */
	unbindQueue(queue: string, source: string, pattern: string): this
	unbindQueue(queue: string, source: string, pattern: string, args: object): this
	unbindQueue(queue: string, source: string, pattern: string, args: object, callback: Callback<IUnbindQueueFields>): this
	 ...
	 * */
	assertExchange(exchange: string, type: ExchangeTypes): this
	assertExchange(exchange: string, type: ExchangeTypes, options: Partial<IAssertExchangeOptions>): this
	assertExchange(exchange: string, type: ExchangeTypes, options: Partial<IAssertExchangeOptions>, callback: Callback<IAssertExchangeFields>): this

	/**
	 * Check that an exchange exists. If it does not exist, the channel will be closed with an error.
	 * If it does exist, happy days.
	 * */
	checkExchange(exchange: string): this
	checkExchange(exchange: string, callback: Callback<ICheckExchangeFields>): this
	 ...
	 * raise an error1).
	 * */
	deleteExchange(exchange: string): this
	deleteExchange(exchange: string, options: Partial<IDeleteExchangeOptions>): this
	deleteExchange(exchange: string, options: Partial<IDeleteExchangeOptions>, callback: Callback<IDeleteExchangeFields>): this
	 ...
	 * */
	bindExchange(destination: string, source: string, pattern: string): this
	bindExchange(destination: string, source: string, pattern: string, args: object): this
	bindExchange(destination: string, source: string, pattern: string, args: object, callback: Callback<IBindExchangeFields>): this
	 ...
	 * */
	unbindExchange(destination: string, source: string, pattern: string): this
	unbindExchange(destination: string, source: string, pattern: string, args: object): this
	unbindExchange(destination: string, source: string, pattern: string, args: object, callback: Callback<IBindExchangeFields>): this
	 ...
	 * */
	consume(queue: string, listener: MessageListener): this
	consume(queue: string, listener: MessageListener, options: Partial<IConsumeOptions>): this
	consume(queue: string, listener: MessageListener, options: Partial<IConsumeOptions>, callback: Callback<IConsumeFields>): this
	 ...
	 * */
	cancel(consumerTag: string): this
	cancel(consumerTag: string, callback: Callback<IFields>): this
	 ...
	 * */
	get(queue: string): this
	get(queue: string, options: Partial<IGetOptions>): this
	get(queue: string, options: Partial<IGetOptions>, callback: Callback<Message | Boolean>): this
	 ...
	 * */
	ack(message: Message): this
	ack(message: Message, allUpTo: boolean): this
	 ...
	 * */
	nack(message: Message): this
	nack(message: Message, allUpTo: boolean): this
	nack(message: Message, allUpTo: boolean, requeue: boolean): this
	 ...
	 * */
	reject(message: Message): this
	reject(message: Message, requeue: boolean): this
	...
	prefetch(count: number, global: boolean, callback: Callback<unknown>)
	 ...
	 * */
	recover(): this
	recover(callback: Callback<IFields>): this
}

export function connect(callback: Callback<Connection>)
export function connect(options: Partial<SocketOptions>, callback: Callback<Connection>)
export function connect(url: string, callback: Callback<Connection>)
export function connect(url: string, options: Partial<SocketOptions>, callback: Callback<Connection>)
